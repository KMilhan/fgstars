...
class Manager : public QDialog, public Ui::Manager
{
    ...
    private:
        ...
        QLabel *m_simulatorCameraStateL { nullptr };
        QCheckBox *m_simulatorCoolerCB { nullptr };
        QDoubleSpinBox *m_simulatorCameraTargetTempSB { nullptr };
        QSpinBox *m_simulatorGainSB { nullptr };
        QSpinBox *m_simulatorFocusSB { nullptr };
        QLabel *m_simulatorCameraStatusL { nullptr };
        QLabel *m_simulatorMountStateL { nullptr };
        ...
        QLabel *m_simulatorSiteStateL { nullptr };
        QCheckBox *m_simulatorGpsdCB { nullptr };
        QLabel *m_simulatorGpsdStatusL { nullptr };
        QLabel *m_simulatorGuideStateL { nullptr };
