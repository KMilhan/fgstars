...
string(FIND "${out}" "-o lib${TARGET_NAME}.so" POS) #we trim the initial arguments, we want the ones in the end. we find the target
if (${POS} EQUAL -1)
    string(FIND "${out}" "-o ../libs/armeabi-v7a/lib${TARGET_NAME}.so" POS) #we trim the initial arguments, we want the ones in the end. we find the target
endif ()
...
set(extralibs)
foreach(lib IN LISTS outout) # Qt deployment handles Qt libraries itself.
